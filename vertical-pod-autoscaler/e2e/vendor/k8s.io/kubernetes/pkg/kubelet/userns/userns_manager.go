...
<<<<<<<< HEAD:cluster-autoscaler/vendor/k8s.io/kubernetes/pkg/kubelet/userns/userns_manager.go
...
========
>>>>>>>> upstream-release-1.30.0:vertical-pod-autoscaler/e2e/vendor/k8s.io/kubernetes/pkg/kubelet/userns/userns_manager.go
