...
<<<<<<<< HEAD:vertical-pod-autoscaler/e2e/vendor/k8s.io/kubelet/pkg/apis/dra/v1alpha1/api.pb.go
package dra
========
package v1alpha2
>>>>>>>> upstream-release-1.29.0:cluster-autoscaler/vendor/k8s.io/kubelet/pkg/apis/dra/v1alpha2/api.pb.go
